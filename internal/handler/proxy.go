...
import (
	...
	"github.com/user/ai-model-proxy/internal/router"
	"github.com/user/ai-model-proxy/internal/transformer"
)
...
func (h *ProxyHandler) ChatCompletions(c *gin.Context) {
	...
	if result.Provider.APIType == "anthropic" {
		httpReq.Header.Set("x-api-key", result.Provider.GetDecryptedAPIKey())
		httpReq.Header.Set("anthropic-version", "2023-06-01")
	} else {
		httpReq.Header.Set("Authorization", "Bearer "+result.Provider.GetDecryptedAPIKey())
	}
